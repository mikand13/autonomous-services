...
@service_manager = Java::ComNannoqToolsClusterServices::ServiceManager::Companion
@heartbeat_service_class = Java::ComNannoqToolsClusterServices::HeartbeatService.java_class

def vertx_start_async start_future
  @service_manager.getInstance.consumeService(@heartbeat_service_class, "GatewayHeartbeat") do |res|
    if res.succeeded
