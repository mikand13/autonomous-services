object Versions {
    ...
    const val nannoq_tools_version = "1.1.7"
    ...
    const val awssdk_version = "1.11.651"
    ...
    const val gradle_docker_version = "0.22.1"
    const val gradle_spawn_version = "0.8.2"
    const val gradle_shadow_version = "5.1.0"
    const val gradle_karma_version = "1.4.4"
    const val gradle_node_version = "2.1.1"
...
object JsVersions {
    const val node_version = "10.16.3"
